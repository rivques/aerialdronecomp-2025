...
yellow_keyhole = np.array([color_mat_size/2+prog_mat_size[0]+in_to_m(18), in_to_m(57), in_to_m(54)+keyhole_outer_dia/2])
green_keyhole = np.array([color_mat_size/2+prog_mat_size[0], in_to_m(107), in_to_m(42)+keyhole_outer_dia/2])

landing_pad = np.array([in_to_m(70), in_to_m(96), 0])
large_landing_cube = np.array([in_to_m(48), in_to_m(96), in_to_m(22)])
small_landing_cube = np.array([in_to_m(30), in_to_m(96), in_to_m(15)])